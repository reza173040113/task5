...
class HalamanDetailDalamNegeri extends StatefulWidget {
  @override
  _HalamanDetailDalamNegeriState createState() =>
      _HalamanDetailDalamNegeriState();
}

class _HalamanDetailDalamNegeriState extends State<HalamanDetailDalamNegeri> {
  Future<List> getData() async {
    final response =
        await http.get("http://192.168.18.4/flutter-server/getDalamNegeri.php");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Halaman Dalam Negeri'),
